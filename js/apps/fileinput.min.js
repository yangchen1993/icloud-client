...
!function (e) {
    ...
    var i = function (e) {
        ...
        data: {}, init: function (e) {
            ...
            var r, l, o = "init_" + t, s = a.data[i], d = s.config[t], c = s.initId + "-" + o, p = " file-preview-initial";
            return n = void 0 === n ? !0 : n, null === s.content[t] ? "" : (Z(d) || Z(d.frameClass) || (p += " " + d.frameClass), r = s.template.replace(/\{previewId\}/g, c).replace(/\{frameClass\}/g, p).replace(/\{fileindex\}/g, o).replace(/\{content\}/g, s.content[t]).replace(/\{footer\}/g, a.footer(i, t, n)), s.tags.length && s.tags[t] && (r = K(r, s.tags[t])), Z(d) || Z(d.frameAttr) || (l = e(document.createElement("div")).html(r), l.find(".file-preview-initial").attr(d.frameAttr), r = l.html(), l.remove()), r)
        }, add: function (i, t, n, r, l) {
            var o, s = e.extend(!0, {}, a.data[i]);
            return H(t) || (t = t.split(s.delimiter)), l ? (o = s.content.push(t) - 1, s.config[o] = n, s.tags[o] = r) : (o = t.length, s.content = t, s.config = n, s.tags = r), a.data[i] = s, o
            ...
            } else s.content = t, s.config = n, s.tags = r;
            a.data[i] = s
        }, unset: function (e, i) {
            var t = a.count(e);
            if (t) {
            ...
            var i, t = "", n = a.data[e], r = a.count(e, !0);
            if (0 === r)return {content: "", caption: ""};
            for (var l = 0; r > l; l++)t += a.get(e, l);
            return i = n.msg(a.count(e)), {content: t, caption: i}
        }, footer: function (e, i, t) {
            var n = a.data[e];
            if (t = void 0 === t ? !0 : t, 0 === n.config.length || Z(n.config[i]))return "";
            var r = n.config[i], l = W("caption", r) ? r.caption : "", o = W("width", r) ? r.width : "auto", s = W("url", r) ? r.url : !1, d = W("key", r) ? r.key : null, c = s === !1 && t, p = n.isDelete ? n.actions(!1, !0, c, s, d) : "", u = n.footer.replace(/\{actions\}/g, p);
        ...
        object: L,
        other: O
    }, M = ["image", "html", "text", "video", "audio", "flash", "object"], B = {
    ...
    }, X = window.URL || window.webkitURL, J = function (t, a) {
        var n = this;
    ...
    J.prototype = {
        constructor: J, validate: function () {
            var e, i = this;
            ...
            var i = this, t = W(e, i.layoutTemplates) ? i.layoutTemplates[e] : R[e];
            return Z(i.customLayoutTags) ? t : K(t, i.customLayoutTags)
        }, getPreviewTemplate: function (e) {
            var i = this, t = W(e, i.previewTemplates) ? i.previewTemplates[e] : z[e];
            return Z(i.customPreviewTags) ? t : K(t, i.customPreviewTags)
        }, parseFilePreviewIcon: function (i, t) {
            var a, n = this, r = n.previewFileIcon;
            return t && t.indexOf(".") > -1 && (a = t.split(".").pop(), n.previewFileIconSettings && n.previewFileIconSettings[a] && (r = n.previewFileIconSettings[a]), n.previewFileExtSettings && e.each(n.previewFileExtSettings, function (e, i) {
            ...
            var i = this, a = i.$element, n = i.$captionContainer, r = i.$btnFile, l = a.closest("form"), o = i.$container;
            t(a, "change", e.proxy(i.change, i)), t(r, "click", function () {
                i.raise("filebrowse"), i.isError && !i.isUploadable && i.clear(), n.focus()
                ...
                var a, n = e(this), r = !n.hasClass("disabled") && Z(n.attr("disabled"));
            ...
            n.html(a), i.isError = !0, i.updateFileDetails(0), n.fadeIn(800), i.raise("fileerror", [e]), i.clearFileInput(), s(i.$container, "has-error")
            ...
            i.getThumbs().each(function () {
                ...
                -1 !== r && (void 0 !== l ? (a[t] = l, n.attr({
                    ...
                    "data-fileindex": t
                }), t += 1) : n.attr({id: "uploaded-" + q(), "data-fileindex": "-1"}))
            }), i.filestack = a
        }, destroy: function () {
            ...
            var i = this, a = i.$container.find(".file-drop-zone"), n = "dragenter.fileinput dragover.fileinput drop.fileinput";
            ...
            i.$preview.find(".kv-file-remove").each(function () {
                var n, r, l = e(this), o = l.closest(".file-preview-frame"), s = o.attr("data-fileindex");
                t(l, "click", function () {
                    return i.validateMinCount() ? (i.cleanMemory(o), void o.fadeOut("slow", function () {
                        i.filestack[s] = void 0, i.clearObjects(o), o.remove();
                        var e = i.getFileStack(!0), t = e.length, l = a.count(i.id);
                        i.clearFileInput(), 0 === t && 0 === l ? i.reset() : (n = l + t, r = n > 1 ? i.getMsgSelected(n) : e[0] ? e[0].name : "", i.setCaption(r))
                    })) : !1
                })
            }), i.$preview.find(".kv-file-upload").each(function () {
                var a = e(this);
                t(a, "click", function () {
                    var e = a.closest(".file-preview-frame"), t = e.attr("data-fileindex");
            ...
            return n.isUploadable ? (t = l.replace(/\{actions\}/g, n.renderFileActions(!0, !0, !1, !1, !1)), a = t.replace(/\{caption\}/g, e).replace(/\{width\}/g, i).replace(/\{indicator\}/g, r.indicatorNew).replace(/\{indicatorTitle\}/g, r.indicatorNewTitle)) : a = l.replace(/\{actions\}/g, "").replace(/\{caption\}/g, e).replace(/\{width\}/g, i).replace(/\{indicator\}/g, "").replace(/\{indicatorTitle\}/g, ""), a = K(a, n.previewThumbTags)
        }, renderFileActions: function (e, i, t, a, n) {
            if (!e && !i)return "";
            var r = this, l = a === !1 ? "" : ' data-url="' + a + '"', o = n === !1 ? "" : ' data-key="' + n + '"', s = r.getLayoutTemplate("actionDelete"), d = "", c = r.getLayoutTemplate("actions"), p = r.otherActionButtons.replace(/\{dataKey\}/g, o), u = r.fileActionSettings, f = t ? u.removeClass + " disabled" : u.removeClass;
            return s = s.replace(/\{removeClass\}/g, f).replace(/\{removeIcon\}/g, u.removeIcon).replace(/\{removeTitle\}/g, u.removeTitle).replace(/\{dataUrl\}/g, l).replace(/\{dataKey\}/g, o), e && (d = r.getLayoutTemplate("actionUpload").replace(/\{uploadClass\}/g, u.uploadClass).replace(/\{uploadIcon\}/g, u.uploadIcon).replace(/\{uploadTitle\}/g, u.uploadTitle)), c.replace(/\{delete\}/g, s).replace(/\{upload\}/g, d).replace(/\{other\}/g, p)
            ...
            var i, t = this, n = t.initialCaption || "";
            ...
            var i = this, n = i.deleteExtraData || {}, r = function () {
                0 === i.$preview.find(".kv-file-remove").length && (i.reset(), i.initialCaption = "")
            };
            i.$preview.find(".kv-file-remove").each(function () {
                var l = e(this), o = l.data("url") || i.deleteUrl, d = l.data("key");
                if (!Z(o) && void 0 !== d) {
                    var c, p, u, f, v = l.closest(".file-preview-frame"), g = a.data[i.id], m = v.data("fileindex");
                    m = parseInt(m.replace("init_", "")), u = Z(g.config) && Z(g.config[m]) ? null : g.config[m], f = Z(u) || Z(u.extra) ? n : u.extra, "function" == typeof f && (f = f()), p = {
                        id: l.attr("id"),
                        key: d,
                        extra: f
                    }, c = e.extend({
                        ...
                        success: function (e, t, n) {
                            var o, s;
                            return Z(e) || Z(e.error) ? (a.unset(i.id, m), o = a.count(i.id), s = o > 0 ? i.getMsgSelected(o) : "", i.raise("filedeleted", [d, n, f]), i.setCaption(s), v.removeClass("file-uploading").addClass("file-deleted"), void v.fadeOut("slow", function () {
                                i.clearObjects(v), v.remove(), r(), o || 0 !== i.getFileStack().length || (i.setCaption(""), i.reset())
                        ...
                        error: function (e, t, a) {
                            ...
                            p.jqXHR = e, p.response = {}, i.showError(n, p, "filedeleteerror"), v.removeClass("file-uploading"), r()
                        }
            ...
            e.uploadCache = {
                ...
                tags: [],
                append: !0
            }, e.uploadCount = 0, e.uploadPercent = 0, e.$btnUpload.removeAttr("disabled"), e.setProgress(0), s(e.$progress, "hide"), e.resetErrors(!1), e.ajaxAborted = !1, e.ajaxRequests = []
        }, cancel: function () {
            ...
            var a = this, n = a.getExtraData(i, t);
            ...
            var o, s = this;
            s.raise("filepreajax", [r, l]), s.uploadExtra(r, l), o = e.extend({
                xhr: function () {
            ...
            i.getThumbs(".file-preview-success").each(function () {
                var a = e(this), n = a.find(".kv-file-remove");
                n.removeAttr("disabled"), t(n, "click", function () {
            ...
            var r, l, o, d, c, p, u, f, v, g = this, m = g.getFileStack().length, h = new FormData, w = g.previewInitId + "-" + i, b = e("#" + w + ":not(.file-preview-initial)"), C = b.find(".kv-file-upload"), x = b.find(".kv-file-remove"), y = g.filestack.length > 0 || !e.isEmptyObject(g.uploadExtraData), T = {
                id: w,
                index: i
            };
            g.formdata = h, 0 === m || !y || C.hasClass("disabled") || g.abort(T) || (o = function () {
                var e = g.getThumbs(".file-uploading");
                e.length > 0 || g.fileBatchCompleted || (g.fileBatchCompleted = !0, setTimeout(function () {
                    a.set(g.id, g.uploadCache.content, g.uploadCache.config, g.uploadCache.tags, g.uploadCache.append), g.hasInitData && (g.initPreview(), g.initPreviewDeletes()), g.setProgress(100), g.unlock(), g.clearFileInput(), g.raise("filebatchuploadcomplete", [g.filestack, g.getExtraData()])
                }, 100))
            }, d = function () {
                !n || 0 === m || g.uploadPercent >= 100 || (g.uploadCount += 1, l = 80 + Math.ceil(20 * g.uploadCount / m), g.uploadPercent = Math.max(l, g.uploadPercent), g.setProgress(g.uploadPercent), g.initPreviewDeletes())
            }, c = function () {
                C.removeAttr("disabled"), x.removeAttr("disabled"), b.removeClass("file-uploading")
            }, p = function (t) {
                r = g.getOutData(t), b.hasClass("file-preview-success") || (g.setThumbStatus(b, "Loading"), s(b, "file-uploading")), C.attr("disabled", !0), x.attr("disabled", !0), n || g.lock(), g.raise("filepreupload", [r, w, i]), T = e.extend(T, r), g.abort(T) && (t.abort(), g.setProgress(100))
            }, u = function (t, a, l) {
                r = g.getOutData(l, t), T = e.extend(T, r), setTimeout(function () {
                ...
                setTimeout(function () {
                    d(), c(), n ? o() : g.unlock(!1), g.initSuccessThumbs()
                }, 100)
            }, v = function (a, r, l) {
                var o = g.parseError(a, l, n ? t[i].name : null);
                g.setThumbStatus(b, "Error"), T = e.extend(T, g.getOutData(a)), g.showUploadError(o, T)
            }, h.append(g.uploadFileAttr, t[i]), h.append("file_id", i), g.ajaxSubmit(p, u, f, v, w, i))
        }, uploadBatch: function () {
            var i, t, a, n, r, l = this, o = l.filestack, d = o.length, c = {}, p = l.filestack.length > 0 || !e.isEmptyObject(l.uploadExtraData);
            l.formdata = new FormData, 0 !== d && p && !l.abort(c) && (i = function () {
                ...
                var r = l.getOutData(n, t), o = l.getThumbs(), s = 0;
                keys = Z(t) || Z(t.errorkeys) ? [] : t.errorkeys, Z(t) || Z(t.error) ? (l.raise("filebatchuploadsuccess", [r]), i(), l.showPreview ? (o.each(function () {
                    ...
                    return i.removeClass("file-uploading"), a.removeAttr("disabled"), t.removeAttr("disabled"), 0 === keys.length ? void l.setThumbStatus(i, "Error") : (-1 !== e.inArray(s, keys) ? l.setThumbStatus(i, "Error") : (i.find(".kv-file-upload").hide(), l.setThumbStatus(i, "Success"), l.filestack[s] = void 0), void s++)
            ...
            n.formdata = new FormData, n.abort(r) || (e = function (e) {
                ...
                n.setProgress(100), n.unlock(), n.clearFileInput(), n.raise("filebatchuploadcomplete", [n.filestack, n.getExtraData()])
            }, a = function (e, i, t) {
            ...
            return 0 === n.find("ul").length ? n.html("<ul><li>" + e + "</li></ul>") : n.find("ul").append("<li>" + e + "</li>"), n.fadeIn(800), a.raise(r, [i]), a.$container.removeClass("file-input-new"), s(a.$container, "has-error"), !0
        }, showError: function (e, i, t) {
            var a = this, n = a.$errorContainer, r = t || "fileerror";
            return i = i || {}, i.reader = a.reader, n.html(e), n.fadeIn(800), a.raise(r, [i]), a.isUploadable || a.clearFileInput(), a.$container.removeClass("file-input-new"), s(a.$container, "has-error"), a.$btnUpload.attr("disabled", !0), !0
            ...
            if (this.showPreview) {
                var n = this, r = X.createObjectURL(i), l = "", o = i ? i.name : "", s = n.previewSettings.other || B.other, d = n.renderFileFooter(i.name, s.width), c = t.slice(t.lastIndexOf("-") + 1), p = n.parseFilePreviewIcon(n.getPreviewTemplate("other"), o);
                a === !0 && (l = " btn disabled", n.isUploadable || (d += '<div class="file-other-error" title="' + n.fileActionSettings.indicatorErrorTitle + '">' + n.fileActionSettings.indicatorError + "</div>")), n.$preview.append("\n" + p.replace(/\{previewId\}/g, t).replace(/\{frameClass\}/g, l).replace(/\{fileindex\}/g, c).replace(/\{caption\}/g, n.slug(i.name)).replace(/\{width\}/g, s.width).replace(/\{height\}/g, s.height).replace(/\{type\}/g, i.type).replace(/\{data\}/g, r).replace(/\{footer\}/g, d)), a === !0 && n.isUploadable && n.setThumbStatus(e("#" + t), "Error")
            }
        }, previewFile: function (e, i, t, a, n) {
            if (this.showPreview) {
                var r, l, o, s = this, d = s.parseFileType(i), c = i ? i.name : "", p = s.slug(c), u = s.allowedPreviewTypes, f = s.allowedPreviewMimeTypes, v = s.getPreviewTemplate(d), g = u && u.indexOf(d) >= 0, m = W(d, s.previewSettings) ? s.previewSettings[d] : B[d], h = f && -1 !== f.indexOf(i.type), w = s.renderFileFooter(p, m.width), b = "", C = a.slice(a.lastIndexOf("-") + 1);
            ...
            function t(e) {
                if (Z(n.attr("multiple")) && (u = 1), e >= u)return a.isUploadable && a.filestack.length > 0 ? a.raise("filebatchselected", [a.getFileStack()]) : a.raise("filebatchselected", [i]), o.removeClass("loading"), void s.html("");
                var m, h, w, b, C, x, y = v + e, T = p + "-" + y, F = i[e], E = a.slug(F.name), k = (F.size || 0) / 1e3, $ = "", I = X.createObjectURL(F), S = 0, P = a.allowedFileTypes, D = Z(P) ? "" : P.join(", "), U = a.allowedFileExtensions, j = Z(U) ? "" : U.join(", ");
                if (Z(U) || ($ = new RegExp("\\.(" + U.join("|") + ")$", "i")), k = k.toFixed(2), a.maxFileSize > 0 && k > a.maxFileSize)return b = a.msgSizeTooLarge.replace("{name}", E).replace("{size}", k).replace("{maxSize}", a.maxFileSize), void(a.isError = g(b, F, T, e));
                if (!Z(P) && H(P)) {
                    for (w = 0; w < P.length; w += 1)C = P[w], h = f[C], x = void 0 !== h && h(F.type, E), S += Z(x) ? 0 : x.length;
                    if (0 === S)return b = a.msgInvalidFileType.replace("{name}", E).replace("{types}", D), void(a.isError = g(b, F, T, e))
                }
                return 0 !== S || Z(U) || !H(U) || Z($) || (x = E.match($), S += Z(x) ? 0 : x.length, 0 !== S) ? a.showPreview ? (r.length > 0 && void 0 !== FileReader ? (s.html(d.replace("{index}", e + 1).replace("{files}", u)), o.addClass("loading"), l.onerror = function (e) {
                    ...
                    a.previewFile(e, F, i, T, I), a.initFileActions()
            ...
            var a = this, n = a.$element, r = a.$preview, l = a.reader, o = a.$previewContainer, s = a.$previewStatus, d = a.msgLoading, c = a.msgProgress, p = a.previewInitId, u = i.length, f = a.fileTypeSettings, v = a.filestack.length, g = function (t, n, r, l) {
            ...
            var i = this, t = i.$element, n = i.getFileStack(), r = t.val() || n.length && n[0].name || "", l = i.slug(r), o = i.isUploadable ? n.length : e, s = a.count(i.id) + o, d = o > 1 ? i.getMsgSelected(s) : l;
            ...
            var r, l, o, s, d, c, p = arguments.length > 1, u = p ? i.originalEvent.dataTransfer.files : n.get(0).files, f = Z(n.attr("multiple")), v = 0, g = 0, m = t.filestack.length, h = t.isUploadable, w = f && m > 0, b = function (i, a, n, r) {
                var l = e.extend(t.getOutData({}, {}, u), {id: n, index: r}), o = {id: n, index: r, file: a, files: u};
                return t.isUploadable ? t.showUploadError(i, l) : t.showError(i, o)
            };
            if (t.reader = null, t.resetUpload(), t.hideFileIcon(), t.isUploadable && t.$container.find(".file-drop-zone ." + t.dropZoneTitleClass).remove(), p)for (r = []; u[v];)s = u[v], s.type || s.size % 4096 !== 0 ? r.push(s) : g++, v++; else r = void 0 === i.target.files ? i.target && i.target.value ? [{name: i.target.value.replace(/^.+\\/, "")}] : [] : i.target.files;
            if (Z(r) || 0 === r.length)return h || t.clear(), t.showFolderError(g), void t.raise("fileselectnone");
            ...
            t.isPreviewable ? t.readFiles(r) : t.updateFileDetails(1), t.showFolderError(g)
        }, validateImage: function (e, i) {
            var a, n, r, l = this, o = l.$preview, s = o.find("#" + i), d = "Untitled", c = s.find("img");
            c.length && t(c, "load", function () {
                n = s.width(), r = o.width(), n > r && (c.css("width", "100%"), s.css("width", "97%")), a = {
                    ind: e,
                    id: i
                }, l.checkDimensions(e, "Small", c, s, d, "Width", a), l.checkDimensions(e, "Small", c, s, d, "Height", a), l.checkDimensions(e, "Large", c, s, d, "Width", a), l.checkDimensions(e, "Large", c, s, d, "Height", a), l.raise("fileimageloaded", [i]), X.revokeObjectURL(c.attr("src"))
            })
        }, checkDimensions: function (e, i, t, a, n, r, l) {
            var o, s, d, c, p = this, u = "Small" === i ? "min" : "max", f = p[u + "Image" + r];
            !Z(f) && t.length && (d = t[0], s = "Width" === r ? d.naturalWidth || d.width : d.naturalHeight || d.height, c = "Small" === i ? s >= f : f >= s, c || (o = p["msgImage" + r + i].replace("{name}", n).replace("{size}", f), p.showUploadError(o, l), p.setThumbStatus(a, "Error"), p.filestack[e] = null))
            ...
            r.$caption.html(n), r.$caption.attr("title", a), r.$captionContainer.find(".file-caption-ellipsis").attr("title", a)
            ...
            var i = this, t = i.getLayoutTemplate("btnDefault"), a = i[e + "Class"], n = i[e + "Title"], r = i[e + "Icon"], l = i[e + "Label"], o = i.isDisabled ? " disabled" : "", s = "button";
            switch (e) {
                case"remove":
            ...
            return a += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", t.replace("{type}", s).replace("{css}", a).replace("{title}", n).replace("{status}", o).replace("{icon}", r).replace("{label}", l)
        }
        ...
        if (r() || i(9)) {
            ...
            return a.shift(), this.each(function () {
                ...
                r || (i = e.extend({}, e.fn.fileinput.defaults), "en" === o || Z(e.fn.fileinputLocales[o]) || (i = e.extend(i, e.fn.fileinputLocales[o])), r = new J(this, e.extend(i, l, n.data())), n.data("fileinput", r)), "string" == typeof t && r[t].apply(r, a)
            })
        }
